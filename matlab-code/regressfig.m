function regressfig(y_data, f)

%% Docs
% Create scatter plot of y_data and f
% where 
% y_data - real data
% f - modelled data
% Also linear fit is plotted with equation and residual plot (norm of residual).

%% Create figure
[y_data,f]=intrapolx(y_data,f);
...
% Create scatter
scatter1 = scatter(y_data,f,'DisplayName','Scatter','Parent',axes1);
